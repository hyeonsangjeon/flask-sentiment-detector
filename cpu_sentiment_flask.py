...
####################################################################################################
from werkzeug.utils import cached_property #pip  install --upgrade Werkzeug==0.16.1
# Custom packages
import numpy as np
import sys
...
ns_conf = api.namespace('sentiment', description='Sentence emotion detector operations')
